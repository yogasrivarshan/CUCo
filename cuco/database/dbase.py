...
from cuco.llm.embedding import EmbeddingClient
...
class DatabaseConfig:
    ...
    # Multi-API island support
    island_api_types: Optional[Dict[int, str]] = None  # e.g. {0: "lsa", 1: "gin", 2: "hybrid"}
    migration_graph: Optional[Dict[int, List[int]]] = None  # e.g. {0: [2], 1: [2], 2: []}
